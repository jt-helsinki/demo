...
const ANDROID_RIPPLE = {
  dark: {
    primary: { color: withOpacity(COLOURS.dark.grey3, 0.4), borderless: false },
    secondary: { color: withOpacity(COLOURS.dark.grey5, 0.8), borderless: false },
    plain: { color: withOpacity(COLOURS.dark.grey5, 0.8), borderless: false },
    tonal: { color: withOpacity(COLOURS.dark.grey5, 0.8), borderless: false },
  },
  light: {
    primary: { color: withOpacity(COLOURS.light.grey4, 0.4), borderless: false },
    secondary: { color: withOpacity(COLOURS.light.grey5, 0.4), borderless: false },
    plain: { color: withOpacity(COLOURS.light.grey5, 0.4), borderless: false },
    tonal: { color: withOpacity(COLOURS.light.grey6, 0.4), borderless: false },
  },
};
